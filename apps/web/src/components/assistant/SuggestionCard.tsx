...
export const SuggestionCard: React.FC<SuggestionCardProps> = ({
  ...
  const typeLabels: Record<string, { label: string; color: string }> = {
    ...
    task: { label: 'Task Item', color: 'text-indigo-400 bg-indigo-950/40 border-indigo-800/50' },
    search_synthesis: { label: 'Synthesis', color: 'text-purple-400 bg-purple-950/40 border-purple-800/50' },
        ...
        <div className="pt-2 border-t border-[#1C202C] flex flex-col gap-1">
          ...
          <div className="flex flex-wrap gap-1.5">
            {suggestion.citations.map((c) => (
              ...
              >
                <ExternalLink className="w-2.5 h-2.5 flex-shrink-0 text-indigo-400" />
