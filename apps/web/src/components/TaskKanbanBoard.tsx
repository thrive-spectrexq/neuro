        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-[#64748B] font-mono">
              {tasks.length} Active Tasks · {tasks.filter((t) => t.status === 'done').length}{' '}
              Completed
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 flex-1 overflow-hidden">
        {columns.map((col) => {
          ...
          return (
            <div
              key={col.id}
              className="flex flex-col bg-[#0F1117] rounded-lg border border-[#1F2433] overflow-hidden"
            >
              <div
                className={`flex items-center justify-between px-3 py-2 border-b border-[#1F2433] ${col.headerBg}`}
              >
                <div className="flex items-center gap-2">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start justify-between gap-2">
                          <h4 className="text-xs font-semibold text-white leading-snug font-mono">
                            {task.title}
                          </h4>
                          <button
