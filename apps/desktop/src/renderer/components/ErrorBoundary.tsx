        ...
        <div className="flex flex-col items-center justify-center min-h-[400px] w-full p-8 text-center bg-gray-900/60 backdrop-blur-md rounded-2xl border border-red-500/20 shadow-2xl">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-lg text-sm font-medium transition-all shadow-lg shadow-cyan-500/20 active:scale-95"
            >
              <RefreshCw size={16} />
              Try Again
            </button>
