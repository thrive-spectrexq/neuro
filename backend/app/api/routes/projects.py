...
from app.api.routes.notes import _get_note_links, _get_note_tags
...
async def list_projects(
    ...
    stmt = (
        ...
        .where(or_(Project.user_id == user_uuid, ProjectMember.user_id == user_uuid))
    )
