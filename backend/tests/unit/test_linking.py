...
from app.api.routes.notes import _update_note_links, _get_note_links
...
async def test_update_and_get_note_links(mocker):
    ...
    source_note = Note(id=uuid.uuid4(), title="Source Note", content="Linking to [[Target Note]]", user_id=user_id)
